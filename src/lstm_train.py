...
from src.eval_lstm import evaluate_lstm_model, print_examples
...
def train_model(train_loader, val_loader, vocab_size, idx2word, 
    ...
    plot_training_history(train_losses, val_rouge1_scores, val_rouge2_scores)
